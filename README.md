...
[![Build Status](https://github.com/shailesh17/traefik-plugin-header-cookie/workflows/Main/badge.svg?branch=master)](https://github.com/shailesh17/traefik-plugin-header-cookie/actions)
...
experimental:
  plugins:
    example:
      moduleName: github.com/shailesh17/traefik-plugin-header-cookie
      version: v0.2.1
```
...
(In the above example, the `plugindemo` plugin will be loaded from the path `./plugins-local/src/github.com/shailesh17/traefik-plugin-header-cookie`.)
